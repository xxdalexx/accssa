<div class="col-sm-6">
    ...
    <h4 class="text-center">Incident Details</h4>
    ...
    @if($this->showDetails)
        ...
        @can('give penalties')
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <textarea wire:model.lazy="displayedReviewerNotes" class="form-control"
                        style="height: 10em; width: 100%;"></textarea>
        ...
        @endcan
    @else
        <p class="text-center">Click a reported incident to view details.</p>
    @endif
